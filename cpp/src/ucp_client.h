...
public:
    UcpClient(ucp_worker_h ucp_worker,
              ...
              ucp_address_t *peer_addr, size_t peer_addr_len): ucp_worker_(ucp_worker), local_addr_(local_addr),
              local_addr_len_(local_addr_len), peer_addr_(peer_addr), peer_addr_len_(peer_addr_len){
