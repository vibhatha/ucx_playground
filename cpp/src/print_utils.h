...
ucs_status_t parse_cmd(int argc, char * const argv[], char **server_name, err_handling* err_handling_opt,
                       ucp_test_mode_t* ucp_test_mode, int print_config, uint16_t server_port, sa_family_t ai_family,
